...
**`DECISIONS.md` is the real document** (`README.md` is the short version for
people arriving at the repo). It records why things are the way they
...
4. Check `DECISIONS.md`'s "Known gaps" before reporting something as broken; it
